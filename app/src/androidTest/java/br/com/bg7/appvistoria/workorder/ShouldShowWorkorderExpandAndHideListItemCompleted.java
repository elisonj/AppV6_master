...
public class ShouldShowWorkorderExpandAndHideListItemCompleted extends WorkorderBaseMatcher {

    @Rule
    public ActivityTestRule<LoginActivity> mActivityTestRule = new ActivityTestRule<>(LoginActivity.class);

    @Test
    public void shouldShowWorkorderExpandAndHideListItemCompleted() {
        try {
            Thread.sleep(200);
        ...
        dataInteraction.onChildView(withId(R.id.status)).check(matches(withText("COMPLETED")));
